...
public class RobotContainer {
  // The robot's subsystems defined
  ...
  public RobotContainer() {
    ...
    // NamedCommands.registerCommand("score", exampleSubsystem.exampleCommand());
    // NamedCommands.registerCommand("score", exampleSubsystem.exampleCommand());
    // NamedCommands.registerCommand("score", exampleSubsystem.exampleCommand());
  ...
  private void configureButtonBindings() {
    new JoystickButton(m_ElevatorController, XboxController.Axis.kRightTrigger.value)
    .whileTrue(m_intake.load());

    new JoystickButton(m_driverController, XboxController.Axis.kLeftTrigger.value)
    .whileTrue(m_intake.release());
